...
cor_structures <- list(
  none = NULL,
  compSymm = corCompSymm(form = ~ time_num | block/irr_system/foliar_trt/new_old),
  symm = corSymm(),
  #ar1 = corAR1(form = ~ time_num | block/irr_system/foliar_trt/new_old),
  car1 = corCAR1(form = ~ time_num | block/irr_system/foliar_trt/new_old),
  arma = corARMA(p = 1, q = 1, form = ~ time_num | block/irr_system/foliar_trt/new_old),
  exp = corExp(form = ~ time_num | block/irr_system/foliar_trt/new_old),
  gaus = corGaus(form = ~ time_num | block/irr_system/foliar_trt/new_old),
  lin = corLin(form = ~ time_num | block/irr_system/foliar_trt/new_old),
  ratio = corRatio(form = ~ time_num | block/irr_system/foliar_trt/new_old),
  spher = corSpher(form = ~ time_num | block/irr_system/foliar_trt/new_old)
)
